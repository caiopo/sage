...
#     f.write(priv_pem.decode('utf-8'))
#
# with open('pub.pem', 'w') as f:
#     f.write(pub_pem.decode('utf-8'))
...
# print(priv_key.private_numbers())
