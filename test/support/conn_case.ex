defmodule SageWeb.ConnCase do
  ...
  by setting `use SageWeb.ConnCase, async: true`, although
  ...
  setup tags do
    Sage.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = Sage.AccountsFixtures.user_fixture()
  ...
  def log_in_user(conn, user) do
    token = Sage.Accounts.generate_user_session_token(user)
